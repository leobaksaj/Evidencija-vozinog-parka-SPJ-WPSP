...
<body>
	...
	<h2 id="preglednaslov">Ažuriranje datuma registracije</h2>
	<div class="container-fluid">
		<a href="javascript:GetModal('modals.php?modal_id=dodaj_novo_vozilo');"  id="zaduzivozilo" class="btn btn-success" role="button">DODAJ NOVO VOZILO</a>
		<table class="table table-striped">
			<thead>
				<tr>
					...
					<th>Vrsta vozila</th>
					<th>Broj dana do <br>isteka registracije</th>
					<th>Ažuriraj</th>
					<th>Obriši</th>
				</tr>
			</thead>
...
<script type="text/javascript" src="js/azurirajRegistraciju.js"></script>
